...
const Hero = () => {
  ...
  return (
    <section className="h-[850px] w-full bg-hero bg-cover bg-right bg-no-repeat text-white pt-[225px] pb-[254px] relative mb-12 lg:bg-center lg:mb-28">
      <div className="container mx-auto text-center">
        <h1 className="text-2xl mx-auto font-semibold mb-[30px] lg:text-[64px] lg:leading-tight lg:max-w-[888px]">{title}</h1>
        <h2 className="mx-auto max-w-[627px] mb-[30px] lg:text-xl lg:mb-[65px]">{subtitle}</h2>
